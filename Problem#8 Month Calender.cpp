...
void PrintMonthClaender(short Year, short Month) {

	short Current = GetDayNameIndex(Year, Month, 1);
	short MaxDay = NumberOfDaysInAMonth(Year,Month);
	...
	for (short Day = 1; Day <= MaxDay; Day++) {
